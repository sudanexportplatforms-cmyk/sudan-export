    ...
    <PortalLayout role="admin" title="Product Catalog">
      <div className="mb-6">
        <p className="text-gray-500 text-sm">
          Manage the core commodity catalog. Click the edit button on any product to update its details.
        </p>
      </div>
              ...
              <CardContent className="p-4">
                ...
                <div className="mt-3 pt-3 border-t border-gray-100 flex justify-between items-center">
                  ...
                  <Button
                    size="sm"
                    variant="ghost"
                    className="h-7 px-2 text-gray-500 hover:text-primary hover:bg-primary/5 gap-1"
          ...
          <div className="space-y-4 py-2">
            ...
            <div className="flex items-center gap-3">
              ...
              <Label className="cursor-pointer" onClick={() => setForm({ ...form, isActive: !form.isActive })}>
                {form.isActive ? "Active (visible to buyers)" : "Inactive (hidden from catalog)"}
              </Label>
            </div>
          </div>
          <DialogFooter>
            <Button variant="outline" onClick={closeEdit} disabled={updateProduct.isPending}>
              Cancel
            </Button>
            <Button
              onClick={handleSave}
              disabled={!form.name.trim() || !form.unit.trim() || updateProduct.isPending}
